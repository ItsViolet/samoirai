...
//            info("APIFactory", "Notif tx json:" + jsonObject.toString());
    ...
    private synchronized void initWalletAmounts() {
        ...
        try {
            if(PrefsUtil.getInstance(context).getValue(PrefsUtil.XPUB44REG, true))    {
                registerXPUB(HD_WalletFactory.getInstance(context).get().getAccount(0).xpubstr(), 44, null);
            }
            if(PrefsUtil.getInstance(context).getValue(PrefsUtil.XPUB49REG, true))    {
                registerXPUB(BIP49Util.getInstance(context).getWallet().getAccount(0).xpubstr(), 49, null);
            }
            if(PrefsUtil.getInstance(context).getValue(PrefsUtil.XPUB84REG, true))    {
                registerXPUB(BIP84Util.getInstance(context).getWallet().getAccount(0).xpubstr(), 84, null);
            }
            if(PrefsUtil.getInstance(context).getValue(PrefsUtil.XPUBPREREG, true))    {
            ...
            if(PrefsUtil.getInstance(context).getValue(PrefsUtil.XPUBPOSTREG, true))    {
            ...
            if(PrefsUtil.getInstance(context).getValue(PrefsUtil.XPUBBADBANKREG, true))    {
            ...
            if(PrefsUtil.getInstance(context).getValue(PrefsUtil.XPUBRICOCHETREG, true))    {
